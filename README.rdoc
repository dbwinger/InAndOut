...
* #app/decorators/models/refinery/inquiries/inquiry_decorator
...
* Home - short text shown under the image rotator.  A "read more" link to "About" page is automatically added (see home.js)
